 ...
 */
fun solve05(): Int {
    val primes = EratosthenesSieve(MAX_VALUE).getPrimes() // Pre-calculate all potential prime factors up until 20

    return IntRange(1, MAX_VALUE) // Iterate over all numbers from 1 to 20
        .flatMap { number ->
